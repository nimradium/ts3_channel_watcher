...
enum Ts3RareErrorType {
    ...
    //ed25519
    ERROR_ed25519_rng_fail                       = 0x1100,
    ERROR_ed25519_signature_invalid              = 0x1101,
    ERROR_ed25519_invalid_key                    = 0x1102,
    ERROR_ed25519_unable_to_create_valid_key     = 0x1103,
    ERROR_ed25519_out_of_memory                  = 0x1104,
    ERROR_ed25519_exists                         = 0x1105,
    ERROR_ed25519_read_beyond_eof                = 0x1106,
    ERROR_ed25519_write_beyond_eof               = 0x1107,
    ERROR_ed25519_version                        = 0x1108,
    ERROR_ed25519_invalid                        = 0x1109,
    ERROR_ed25519_invalid_date                   = 0x110A,
    ERROR_ed25519_unauthorized                   = 0x110B,
    ERROR_ed25519_invalid_type                   = 0x110C,
    ERROR_ed25519_address_nomatch                = 0x110D,
    ERROR_ed25519_not_valid_yet                  = 0x110E,
    ERROR_ed25519_expired                        = 0x110F,
    ERROR_ed25519_index_out_of_range             = 0x1110,
    ERROR_ed25519_invalid_size                   = 0x1111,
